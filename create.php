<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO products (name,price,date) values(?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($name,$price,$date));
            Database::disconnect();
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="create.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($priceError)?'error':'';?>">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="price" min="1" type="number" placeholder="Product Price" value="<?php echo !empty($price)?$price:'';?>">
